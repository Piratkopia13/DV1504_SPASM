...
D3D11_INPUT_ELEMENT_DESC DeferredInstancedGeometryShader::IED[5] = {
...
D3D11_INPUT_ELEMENT_DESC DeferredInstancedGeometryShader::INSTANCED_IED[7] = {
	{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
{ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
{ "TANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
...
DeferredInstancedGeometryShader::DeferredInstancedGeometryShader()
	...
	Application::getInstance()->getDXManager()->getDevice()->CreateInputLayout(INSTANCED_IED, 7, vsBlob->GetBufferPointer(), vsBlob->GetBufferSize(), &m_inputLayoutInstanced);
...
DeferredInstancedGeometryShader::~DeferredInstancedGeometryShader() {
	...
	Memory::safeRelease(m_inputLayoutInstanced);
}
...
void DeferredInstancedGeometryShader::draw(Model& model, bool bindFirst) {
	...
	if (bindFirst) {
		...
		Application::getInstance()->getDXManager()->getDeviceContext()->IASetInputLayout(m_inputLayoutInstanced);
		//} else {
